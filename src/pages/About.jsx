...
const About = () => {
  ...
  return (
    <div style={styles.pageWrapper}>
      {/* ── HERO HEADER SECTION ── */}
      <section 
        className="relative min-h-[50vh] flex items-center pt-32 pb-20 mb-16 text-center bg-no-repeat overflow-hidden border-b border-gray-100 bg-cover lg:bg-[length:120%_auto]"
        style={{
