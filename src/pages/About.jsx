...
const About = () => {
  ...
  return (
    <div style={styles.pageWrapper}>
      {/* ── HERO HEADER SECTION ── */}
      <section 
        className="relative w-full min-h-[210px] md:min-h-0 md:aspect-[3322/1080] mb-16 bg-no-repeat overflow-hidden border-b border-gray-100 bg-cover md:bg-[length:80%_auto]"
        style={{
