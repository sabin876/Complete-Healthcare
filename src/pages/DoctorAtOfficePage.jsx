...
const services = [
  "General corporate medical check",
  "Fever, flu & cold management",
  "Workplace muscle & back pain relief",
  "On-site laboratory sample collection",
  "Ergonomic health consultation",
  "Stress, anxiety & burnout assessment",
  "DHA sick leaves & medical reports",
  "Corporate flu vaccination campaigns",
  "ECG & desktop vitals monitoring",
  "Corporate group health check packages",
  "Dehydration & office IV therapy",
  "Workplace medical risk screening",
  "Food poisoning & digestive treatment",
  "Follow-up employee consultations",
];
...
export default function DoctorAtOfficePage() {
  ...
  useEffect(() => {
    fetch('http://localhost:8000/api/services/doctor-at-office/')
      .then(res => res.json())
      .then(data => {
        setService({
          ...data,
          ...
          <div className="dah-intro-grid">
            <div>
              ...
              <div className="dah-trust-row">
                {["DHA Licensed", "Zero Downtime", "30 Min Response", "Corporate Plans"].map(t => (
            ...
            <div className="dah-img-wrap">
              <img
                src="https://images.unsplash.com/photo-1527689368864-3a821dbccc34?w=800&q=80&auto=format&fit=crop"
                alt="Corporate wellness doctor at office in Dubai"
              />
              <div className="dah-stat-pill">
                <div style={{ textAlign: "center" }}>
                  <div className="dah-stat-num">Fast</div>
                  <div className="dah-stat-lbl">Response</div>
                </div>
                <div style={{ width: 1, height: 36, background: "#e2e8f0" }} />
                <div style={{ textAlign: "center" }}>
                  <div className="dah-stat-num">100%</div>
                  <div className="dah-stat-lbl">HR Compliant</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="dah-container">
          <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", flexWrap: "wrap", gap: 24 }}>
            <div>
              ...
              <h2 className="dah-title">Workplace Health Service Offerings</h2>
              <p className="dah-desc">Our corporate healthcare team covers a wide range of basic diagnostics, consultations, treatments, and wellness campaigns.</p>
            </div>
      ...
      {service && (
        <section className="faq-section">
          <div className="faq-wrap">
            ...
            <h2 className="faq-title">Doctor at Office FAQs</h2>
            <p className="faq-sub">
              Find answers to the most common questions about our corporate office doctor visits in Dubai.
            </p>
