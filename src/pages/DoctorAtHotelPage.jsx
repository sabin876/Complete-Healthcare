...
const whyCards = [
  {
    ...
    desc: "All hotel room consultations are conducted by licensed clinical professionals under strict Dubai healthcare regulations.",
    badge: "DHA Licensed",
    badgeColor: "#e1f5ee",
    badgeText: "#5eb63b",
  },
  {
    ...
    desc: "Rapid dispatch to all major Dubai hotels, luxury resorts, hotel apartments, and vacation rentals across the city.",
    badge: "Fast Dispatch",
    badgeColor: "#E6F1FB",
    badgeText: "#08709d",
  },
  {
    ...
    desc: "Skip unfamiliar hospitals. Receive comprehensive diagnostics, treatments, and care in the privacy and comfort of your hotel room.",
    badge: "Convenient",
    badgeColor: "#FAEEDA",
    badgeText: "#854F0B",
  },
  {
    ...
    title: "Tourist-Friendly Doctors",
    desc: "Our doctors are multilingual, fluent in English, and highly experienced in treating international travelers and tourists.",
    badge: "Multilingual",
    badgeColor: "#EEEDFE",
    badgeText: "#534AB7",
  },
  {
    ...
    desc: "We provide comprehensive DHA-stamped receipts, medical reports, and notes to facilitate hassle-free insurance claims.",
    badge: "Claims Ready",
    badgeColor: "#FBEAF0",
    badgeText: "#993556",
  },
  {
    ...
    title: "24/7 Hotel On-Call Support",
    desc: "Whether day, night, weekend, or holiday, a licensed doctor is ready to assist you in your hotel suite at any hour.",
    badge: "24/7 Care",
    badgeColor: "#e1f5ee",
    badgeText: "#5eb63b",
  },
...
const services = [
  "General medical room consultation",
  "Food poisoning & stomach bug treatment",
  "Travel sickness & jet lag recovery",
  "Sunburn & heat exhaustion management",
  "In-room dehydration & IV drip therapy",
  "Fever, flu, cough & cold relief",
  "Post-flight ear pain & sinus pressure",
  "Prescription support & local delivery",
  "Travel insurance claims documentation",
  "ECG & hotel room vitals checking",
  "On-site laboratory sample collection",
  "Child & family room medical checks",
  "Allergic reactions & skin conditions",
  "Minor wound checking & injury care",
];
...
export default function DoctorAtHotelPage() {
  ...
  const service = servicesData["doctor-at-hotel"];
        ...
        <div className="dah-container">
          <div className="dah-intro-grid">
            <div>
              ...
              <h2 className="dah-title">Reasons to Call Doctor to Hotel Dubai</h2>
              <p className="dah-desc">
                CORX Healthcare delivers prompt, high-quality, and confidential medical treatments directly to your hotel room or tourist accommodation in Dubai. Our DHA-licensed doctors visit you within 30–45 minutes, providing diagnostic checks, treatment plans, prescriptions, and official medical files.
              </p>
              <p className="dah-desc">
                Whether you are traveling for business, holiday, or family vacation, skip the local hospital emergency wait lines. We handle everything from travel sickness, dehydration, and food poisoning to providing DHA-stamped reports for your travel insurance claim.
              </p>
              ...
              <div className="dah-trust-row">
                {["DHA Licensed", "30-45 Min Arrival", "24/7 Room Care", "Insurance Ready"].map(t => (
            ...
            <div className="dah-img-wrap">
              <img
                ...
                alt="Hotel room doctor visit medical consultation in Dubai"
              />
              <div className="dah-stat-pill">
                <div style={{ textAlign: "center" }}>
                  <div className="dah-stat-num">24/7</div>
                  <div className="dah-stat-lbl">In-Room Care</div>
                </div>
                <div style={{ width: 1, height: 36, background: "#e2e8f0" }} />
                <div style={{ textAlign: "center" }}>
                  <div className="dah-stat-num">Fast</div>
                  <div className="dah-stat-lbl">30-45m Dispatch</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="dah-section">
        <div className="dah-container">
          <div style={{ textAlign: "center" }}>
            ...
            <h2 className="dah-title" style={{ margin: "0 auto 12px" }}>Why Guests Choose Our Doctor at Hotel Service</h2>
            <p style={{ fontSize: 15, color: "#64748b", lineHeight: 1.7, maxWidth: 560, margin: "0 auto" }}>
              Stay relaxed and recover in the comfort of your hotel room with our professional clinical services.
            </p>
          </div>
        ...
        <div className="dah-container">
          <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", flexWrap: "wrap", gap: 24 }}>
            <div>
              ...
              <h2 className="dah-title">Hotel Health Service Offerings</h2>
              <p className="dah-desc">Our hotel room medical service in Dubai covers a comprehensive range of acute traveling sicknesses and urgent wellness therapies.</p>
            </div>
