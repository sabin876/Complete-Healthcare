...
const steps = [
  {
    icon: (
      <svg className="w-10 h-10 text-[#63b158]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    <section className="relative py-20 md:py-28 bg-gradient-to-b from-slate-50/80 via-white to-slate-50/60 font-sans overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        {[...Array(5)].map((_, i) => (
          <motion.div
            ...
            className={`absolute rounded-full blur-[2px] ${
              i % 2 === 0 ? "w-4 h-4 bg-[#63b158]/30" : "w-3 h-3 bg-[#08709d]/30"
            }`}
            style={{
              left: `${20 + i * 16}%`,
              top: `${15 + (i * 18) % 60}%`
        ...
        <div className="absolute inset-0 bg-[radial-gradient(#63b158_1px,transparent_1px)] [background-size:32px_32px] opacity-[0.04]" />
      </div>

      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 text-center">
        {/* Main Heading in Green Theme */}
        <motion.h2 
        ...
        >
          ...
          <a href="#" className="text-[#63b158] font-semibold underline hover:opacity-80">
            DHA Certified
          </a>{' '}
          ...
          {steps.map((step, idx) => (
            ...
            >
              <div className="w-full">
                {/* Icon */}
                <div className="mb-6 text-[#63b158] group-hover:scale-110 transition-transform duration-300">
                  {step.icon}
                </div>

                {/* Title */}
                <h4 className="text-lg md:text-xl font-bold text-[#63b158] mb-4 font-['Montserrat'] leading-snug">
                  {step.title}
                </h4>
              ...
              <Link
                to="/contact"
                className="inline-flex items-center justify-center px-6 py-2.5 bg-[#63b158] hover:bg-[#529b48] text-white font-bold text-sm rounded-lg transition-colors shadow-md hover:shadow-lg"
              >
                Book Now
              </Link>
            </motion.div>
