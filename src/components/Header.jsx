  ...
  return (
    <header className="relative w-full z-50">
      ...
      <div className="bg-white transition-all duration-300 border-b border-gray-100 py-0 shadow-sm">
        <div className="w-full max-w-[1440px] mx-auto px-6 md:px-12 flex justify-between items-center h-20 md:h-28">
          {/* Logo */}
      ...
      <nav className="hidden lg:block bg-[#08709d] text-white shadow-xl relative z-10">
        <div className="w-full max-w-[1440px] mx-auto px-6 md:px-12 flex justify-between items-center py-0">
