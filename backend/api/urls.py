...
from .views import (
    ...
    BlogPostViewSet, ServiceViewSet, TeamMemberViewSet, DriverScheduleViewSet, HomePageViewSet, upload_blog_image , send_email,
    robots_txt_view, sitemap_xml_view, sitemap_xsl_view
)
...
urlpatterns = [
    ...
    path('sitemap.xsl', sitemap_xsl_view, name='api_sitemap_xsl'),
